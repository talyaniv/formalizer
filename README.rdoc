...
{<img src="https://raw.githubusercontent.com/talyaniv/formalizer/master/test/dummy/app/assets/images/formalizer.png" alt="Formalizer flow scheme" />}[Formalizer flow scheme]
...
Formalizer will know how to use external URLs or find files (css and images) inside your app's assets directory. If your files resist elsewhere, you will need to give an absolute file:// link. Formalizer *does not* convert style/css url()s in the current version.
